...
public class Book_TheThao_Frg extends Fragment {

    String ulRss = "https://vnexpress.net/rss/the-thao.rss";
    public Book_TheThao_Frg() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_book__the_thao__frg, container, false);
